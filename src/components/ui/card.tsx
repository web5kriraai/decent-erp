  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Flush cards set py-0 on the root — restore top padding on the header
        "group-data-[card-flush=true]/card:pt-(--card-spacing)",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base leading-snug font-semibold text-[var(--color-navy)] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
