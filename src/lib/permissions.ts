export const PERMISSIONS = {
  ...
  /** Grey → Ready Stock shop-floor stages */
  ERP_FLOOR_OPERATE: "ERP_FLOOR_OPERATE",
  /** Sales + Sales Return */
  ERP_SALES_OPERATE: "ERP_SALES_OPERATE",
  /** Accounts / margin posting */
  ERP_ACCOUNTS_OPERATE: "ERP_ACCOUNTS_OPERATE",
} as const;
