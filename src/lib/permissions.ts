...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, PermissionCode[]> = {
  [ROLE_CODES.DESIGN_HEAD]: [
    ...
    // Pattern stages (Concept Review, Sketch Approval, Final Approval) run on My Tasks
  ...
  [ROLE_CODES.PRODUCTION_HEAD]: [PERMISSIONS.PRODUCTION_RELEASE, PERMISSIONS.COST_VIEW],
