...
export const PROCESS_SEED = [
  {
    ...
    subProcesses: [
      ...
      { code: "PUNCH_CHECK", name: "Punching Checking", sequence: 5, role: ROLE_CODES.PUNCHING_CHECKER, isApproval: true },
...
export function buildStandardWorkflowTasks(
  ...
  const rows = [
    ...
    { code: "PUNCH_CHECK", role: ROLE_CODES.PUNCHING_CHECKER, expectedMinutes: 180, dayOffset: 4, priority: "HIGH" as const },
