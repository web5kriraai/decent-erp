    ...
    <div className="page-shell">
      ...
      >
        <div className="stat-grid workbench-pulse">
          ...
          {canViewPipeline && (
            <StatCard label="Active Designs" value={activeDesigns.length} accent={!canExecute && !canApprove} />
          )}
          {canRelease && (
              ...
              {shortcuts.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="workbench-shortcut-text">
                      <span className="workbench-shortcut-label">
                        {item.label}
                        {typeof item.badge === "number" && item.badge > 0 && (
                          <span className="workbench-shortcut-badge">{item.badge}</span>
                        )}
                      </span>
